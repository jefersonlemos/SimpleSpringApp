...
sudo yum update -y && yum install java-17-amazon-corretto-headless -y
...
setsid java -jar /app/spring-boot-app-demo-0.0.1-SNAPSHOT.jar >> /app/spring-boot-app-demo.log 2>&1 < /dev/null &